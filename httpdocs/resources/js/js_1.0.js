	    ...
	    $.validationEngineLanguage = {
	        newLang: function(){
	            $.validationEngineLanguage.allRules = {
	                ...
	                "onlyLetterUn": {
	                    "regex": /^[a-zA-Z\_]+$/,
	                    "alertText": "* Letters and underscore only"
	                },
	                "AtLeastOneNumberOneLowercaseOneUppercase": {
	                    "regex": /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])/,
	                    "alertText": "* At leat one number,one uppercase,one lowercase"
	                },
	                "onlyLetter": {
	                    "regex": /^[a-zA-Z']+$/,
	                    "alertText": "* Letters only"
	                ...
	                "LetterNumberUnderscore": {
	                    "regex": /^[0-9a-zA-Z\_]+$/,
	                    "alertText": "* No special characters allowed except underscore"
	                },
	                "onlyLetterNumber": {
	                    "regex": /^[0-9a-zA-Z]+$/,
	                ...
	                "lowercase": {
	                    "regex": /^[0-9a-z]+$/,
	                    "alertText": "* Only lowercase characters allowed"
	                },
	                "uppercase": {
	                    "regex": /^[0-9a-z]+$/,
	                    "alertText": "* Only uppercase characters allowed"
	                },
					...
					"ajaxUserCallPhp": {
	                    "url": "index.php?route=users&action=register_check_username",
	                    // you may want to pass extra data on the ajax call
	                    //"extraData": "name=eric",
	            	...
	            	"ajaxEmailCallPhp": {
	                    "url": "index.php?route=users&action=register_check_email",
	                    // you may want to pass extra data on the ajax call
	                    //"extraData": "name=eric",
	                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
