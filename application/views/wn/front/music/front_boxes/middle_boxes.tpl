<section>
	<div class="floatleft" id="middle">
		<div id="middle_default">
			<div id="middle_boxes">
				<div>{include
					file="$tpl_dir/front_boxes/boxes/featured_profiles.tpl"}</div>
				<div>{include file="$tpl_dir/front_boxes/boxes/latest_people.tpl"}</div>
				<div>{include
					file="$tpl_dir/front_boxes/boxes/top_rated_people.tpl"}</div>
			</div>
		</div>
		...
		<div id="middle_matches">
			...
			<div>
				...
				file="$tpl_dir/front_boxes/boxes/profile_box.tpl"} {foreachelse}
