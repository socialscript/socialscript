...
<form id="fileupload"
	action="index.php?route=users_content&action=upload_pictures&gallery={$default_pictures_gallery_id}"
...
$.ajax({
	type : "POST",
	url : "index.php?route=users_content&action=get_gallery_pictures",
	data : {
...
$("#pictures").html(response);
	...
	$("#fileupload").attr('action','index.php?route=users_content&action=upload_pictures&gallery='+dropdown.value);
}
function add_gallery()
{
	...
	$.ajax({
		type : "POST",
		url : "index.php?route=users_content&action=add_pictures_gallery",
		data : {
		...
		success : function(response) {
			...
			$.ajax({
				type : "POST",
				url : "index.php?route=users_content&action=pictures_galleries_dropdown",
				data : {
...
$("#fileupload").attr('action','index.php?route=users_content&action=upload_pictures&gallery='+response.id);
					hide_loading();
