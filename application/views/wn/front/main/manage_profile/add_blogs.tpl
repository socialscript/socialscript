...
<div class="floatleft manage_blogs_left">
	...
	<div id="blogs_categories">
		{$languages->select_from_existing_categories}: <select
	...
	<div id="create_new_blog_category">
		...
		<input type="button" name="submit" value="Add"
			class='btn' onclick="add_blog_category()">
	</div>
	<div class="clear"></div>
	<br />
	<div id="add_new_blog" onclick="add_new_blog()"><input type="button" class="btn " value="{$languages->add_new_blog}"></div>
	<br />
...
<div id="add_blog" class="floatleft hidden manage_blogs_right">
	{$languages->title}: <input type="text" name="blog_title"
		id="blog_title" class="btn blog_title">
	<textarea id="blog_text"
		class="btn blog_textarea"></textarea>
...
<div id="edit_blog" class="floatleft hidden manage_blogs_right">
	...
	{$languages->title}: <input type="text" name="edit_blog_title"
		id="edit_blog_title" class="btn blog_title  input">
	<textarea id="edit_blog_text" class="btn  blog_textarea"></textarea>
