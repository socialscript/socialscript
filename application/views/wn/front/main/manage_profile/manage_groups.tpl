...
<div class="floatleft manage_groups_left">

	<div id="groups_categories" style="width: 150px">

		<div id="add_new_group" onclick="add_new_group()">{$languages->add_new_group}</div>
		<br />
		<div id="groups">{include file="$tpl_dir/manage_profile/groups.tpl"}</div>
	</div>
</div>



<div id="add_group" class="floatleft hidden manage_groups_right">
	{$languages->group_name}: <input type="text" name="group_name"
		id="group_name" class="ui-widget-header group_name input"><br />
	{$languages->group_description}:
	<textarea id="group_description"
		class="ui-widget-header group_description"></textarea>
	<br /> {$languages->privacy}: <input type="radio" name="group_privacy"
		id="group_privacy_1" class="ui-widget-header " value="1"
		checked="checked">{$languages->open_to_all} <input type="radio"
		name="group_privacy" id="group_privacy_2" class="ui-widget-header "
		value="2">{$languages->show_in_search_but_closed_to_other_than_members}
	<input type="radio" name="group_privacy" id="group_privacy_3"
		class="ui-widget-header " value="3">{$languages->open_only_to_members}
	<br /> {$languages->location}: <input type="text" name="group_location"
		id="group_location" class="ui-widget-header group_location input"><br />

	<input type="button" value="Submit" onclick="add_group_text()" class="btn">
</div>

<div id="edit_group" class="floatleft manage_groups_right"></div>
<div class="clear"></div>
{literal}
