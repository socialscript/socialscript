<div id="show_trade"  class="accordion"  >
	<div class="accordion-group"> 
    <div class="accordion-heading">
      <a class="accordion-toggle  btn-success" data-toggle="collapse" data-parent="#show_trade" href="#collapseTrade">{$languages->trade}</a>
		</div>
    <div id="collapseTrade" class="accordion-body collapse in">
