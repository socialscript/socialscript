...
<div id="details_right">
	...
	<div id="extra_sections_details">{$extra_section->text}</div>
</div>
	...
	<div>
		...
		<form id="extra_sections_form">
			...
			<input type="button" name="submit"
				onclick="add_extra_sections_comment('{$type}','{$extra_section->id}')"
...
tiny_mce();
$(".extra_sections_comment").addClass('comments_textarea_big');
});
</script>
{/literal}
