<div class="floatleft group_left">
	<div id="add_new_group_music" onclick="add_new_group_music()" class="btn btn-warning">{$languages->add_music}</div>
	<div id="add_music"></div>
	<div id="gallery_musics">{include
		file="$tpl_dir/pages/groups/group_gallery_musics.tpl"}</div>
</div>
...
function delete_group_music(id)
{
	show_loading();

	$.ajax({
		type : "POST",
		url : "index.php?route=users_interaction&action=delete_group_music",
		data : {
