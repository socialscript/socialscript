<div class="floatleft group_left">
	<div id="add_new_group_image" onclick="add_new_group_image()" class="btn btn-warning">{$languages->add_new_image}</div>
...
function delete_group_picture(id)
{
	show_loading();

	$.ajax({
		type : "POST",
		url : "index.php?route=users_interaction&action=delete_group_picture",
		data : {
