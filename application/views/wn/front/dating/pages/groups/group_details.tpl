<div class="group_details_left ui-widget-header">
	...
	<div>
		<br /> {$group->group_description} <br /> {$group->group_location} <br />
...
<div class="group_details_right">
	...
	<div id="tabs_group_details">
		...
		<div id="tabs_group_details-1">{include
			file="$tpl_dir/pages/groups/group_blogs.tpl"}</div>
		<div id="tabs_group_details-2" class="register">{include
			file="$tpl_dir/pages/groups/group_images.tpl"}</div>
		<div id="tabs_group_details-3" class="register">{include
			file="$tpl_dir/pages/groups/group_videos.tpl"}</div>
		<div id="tabs_group_details-4" class="register">{include
			file="$tpl_dir/pages/groups/group_music.tpl"}</div>
		<div id="tabs_group_details-5">{include
...
$("#tabs_group_details").tabs({selected:0});
