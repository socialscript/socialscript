...
<ul class="lavaLampWithImage" id="1">
	...
	{if $settings->users_can_choose_theme
		== 'yes'} {include file="$tpl_dir/elements/theme_roller.tpl"} {/if}
</ul>
...
{if $settings->site_url == 'http://www.on-line-dating.co.uk/'}
		<!--<h3>Welcome to on line dating.The site is free to use so you can register and make new friends.Happy on line dating.</h3>-->
		{/if}
