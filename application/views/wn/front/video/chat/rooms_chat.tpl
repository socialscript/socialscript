...
<div id="chat_rooms_default">{if $user_logged === FALSE && $settings->only_logged_users_can_post_on_chatrooms == 'yes'}
	{$languages->you_need_to_login_to_chat_in_chatrooms}{else}{$languages->chat_choose_a_chatroom}{/if}</div></div>
