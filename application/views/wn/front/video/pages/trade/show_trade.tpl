...
<div id="add_new_trade"><input type="button" class="ui-widget-header  input" onclick="add_new_trade()" value="Add trade">
<div id="add_trade"></div>
</div>
<div class="clear"></div>

		<div id="latest_trade">
{include file="$tpl_dir/pages/trade/trade.tpl"}
</div>
<div id="trade_details"></div>
</div>


<div id="edit_trade" class="floatleft" style="margin-left:50px;width:300px">
