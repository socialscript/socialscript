<h3>
		...
		<div id="comments_group_event_details">
{include file="$tpl_dir/pages/groups/comments.tpl"}
</div>
<div class="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active">

<textarea name="group_event_comment" id="group_event_comment" class="comments_textarea"></textarea>
<input type="button" name="submit" onclick="add_group_event_comment()" value="Submit">
