<div id="add_group_event" class="hidden" style="width:500px">
	Title: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="event_title" id="group_event_title" class="ui-widget-header  input input_text_big" ><br />
	Date: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="event_date" id="group_event_date" class="ui-widget-header  input datepicker"><br />
	Location: <input type="text" name="event_location" id="group_event_location" class="ui-widget-header  input input_text_big"><br />
	<textarea id="group_event_text" style="width: 450px; height: 200px" class="ui-widget-header  input"></textarea>

	<input type="button" value="Submit" onclick="add_group_event_text('{$group->id}')">
</div>
<div class="floatleft group_left">
	<div id="add_new_group_event" onclick="add_new_group_event()">{$languages->add_new_event}</div>
		<div id="group_events">
{include file="$tpl_dir/pages/groups/events.tpl"}
</div>
</div>
