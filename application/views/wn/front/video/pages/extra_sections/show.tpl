<div id="extra_sections">
<div>
				<h3>
					<a href="#">{$type|ucfirst}</a>
				</h3>
				<div class="extra_sections_content">


<div>
	<div id="add_new_extra_sections"><input type="button" class="ui-widget-header  input" onclick="add_new_extra_sections('{$type}')" value="Add"></div>
	<div class="clear"></div>
		<div id="add_extra_sections"></div>
		<div id="latest_extra_sections">
{include file="$tpl_dir/pages/extra_sections/list.tpl"}
</div>
</div>


<div id="edit_extra_sections" class="floatleft" style="margin-left:50px;width:300px">
