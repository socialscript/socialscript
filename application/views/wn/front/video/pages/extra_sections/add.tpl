	...
	{$languages->title}: <input type="text" name="extra_sections_title_{$type}" id="extra_sections_title_{$type}" class="ui-widget-header  input input_text_big">
	<textarea id="extra_sections_text_{$type}" style="width:400px; height: 200px" class="ui-widget-header  input"></textarea>
	<input type="button" value="Submit" onclick="add_extra_sections_text('{$type}')" class="ui-widget-header input">
</div>
