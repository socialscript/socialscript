...
<h3>
	...
	<div class="profile_pic floatleft ">
		...
		<div id="button1" class="button"><a onclick="change_profile_picture()">{$languages->change_profile_picture}</a></div>
		<div id="change_profile_picture" class="hidden">
		<iframe src="index.php?route=users_content&action=upload_profile_picture" frameborder="0" width="250" height="150" scrolling="no"></iframe>
		 </div>
	</div>
	<div class="floatleft">{$user->email}
	<br />
	{$user->country}
	<br />
	{$user->rating}
	...
	<div class="middle_min_height">
	<div id="add_new_extra_sections"><input type="button" class="ui-widget-header  input" onclick="edit_profile()" value="Edit Profile"></div>
	<div class="clear"></div>
	<div id="edit_profile"></div>
	<div>
	{foreach from=$extra_fields item=extra_field}
	<div class="profile_fields_left">
	 	{$extra_field->name}:</div>
<div class="profile_fields_right">
{$extra_field->value}
	</div>
	<div class="clear"></div>
