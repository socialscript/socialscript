...
<br />
	<div id="events">
{include file="$tpl_dir/manage_profile/events.tpl"}
	</div>
</div>
</div>
...
<div id="add_event" class="floatleft hidden" style="margin-left:70px;width:600px">
	{$languages->title}: <input type="text" name="event_title" id="event_title" class="ui-widget-header event_title input"><br />
	{$languages->date}: <input type="text" name="event_date" id="event_date" class="ui-widget-header event_date input datepicker">&nbsp;&nbsp;&nbsp;&nbsp;
	{$languages->location}: <input type="text" name="event_location" id="event_location" class="ui-widget-header event_location  input"><br />
	<textarea id="event_text"   class="ui-widget-header  event_textarea input"></textarea>

	<input type="button" value="Submit"  class="ui-widget-header  input" onclick="add_event_text()">
</div>

<div id="edit_event" class="floatleft hidden" style="margin-left:70px;width:600px">
<div id="event_id" class="hidden"></div>
	{$languages->title}: <input type="text" name="edit_event_title" id="edit_event_title" class="ui-widget-header event_title input"><br />
		{$languages->date}: <input type="text" name="edit_event_date" id="edit_event_date" class="ui-widget-header event_date input datepicker">&nbsp;&nbsp;&nbsp;&nbsp;
	{$languages->location}: <input type="text" name="edit_event_location" id="edit_event_location" class="ui-widget-header  event_location input">
	<textarea id="edit_event_text"   class="ui-widget-header event_textarea input"></textarea>
	<input type="button" value="Submit" onclick="edit_event_text()" class="ui-widget-header  input">
</div>
<div class="clear"></div>
{literal}
