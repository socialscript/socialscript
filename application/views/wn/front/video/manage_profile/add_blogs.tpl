...
<div   class="floatleft">
	...
	<div id="blogs_categories" style="width:150px">
	{$languages->select_from_existing_categories}:<br/>
		<select name="select_blog_categories" id="select_blog_categories"
	...
	<div id="create_new_blog_category">
		{$languages->create_new_category}:<br />
		<input type="text" name="blog_category" id="new_blog_category" class="ui-widget-header  input">
		<br /><input
...
<br />
	<div id="blogs">
{include file="$tpl_dir/manage_profile/blogs.tpl"}
	</div>
...
<div id="add_blog" class="floatleft hidden" style="margin-left:70px;width:800px">
	{$languages->title}: <input type="text" name="blog_title" id="blog_title" class="ui-widget-header blog_title">
	<textarea id="blog_text" style="width: 800px; height: 600px;" class="ui-widget-header blog_textarea"></textarea>
	<input type="button" value="Submit" class="ui-widget-header  input" onclick="add_blog_text()">
</div>

<div id="edit_blog" class="floatleft hidden" style="margin-left:70px;width:600px">
<div id="blog_id" class="hidden"></div>
	{$languages->title}: <input type="text" name="edit_blog_title" id="edit_blog_title" class="ui-widget-header blog_title  input">
	<textarea id="edit_blog_text"  class="ui-widget-header  blog_textarea"></textarea>
	<input type="button" value="Submit" onclick="edit_blog_text()" class="ui-widget-header  input">
</div>
<div class="clear"></div>
{literal}
