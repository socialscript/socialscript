...
<div class="clear"></div>
<section>{include file="$tpl_dir/front_boxes/left_boxes.tpl"}</section>
<div class="separator">&nbsp;</div>
<section>{include file="$tpl_dir/front_boxes/middle_boxes.tpl"}</section>
<div class="separator">&nbsp;</div>
<section>{include file="$tpl_dir/front_boxes/right_boxes.tpl"}</section>
<div class="separator">&nbsp;</div>