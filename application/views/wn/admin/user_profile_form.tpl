<div style="width: 100%; height: 100%; overflow-y: scroll">
	...
	<div class="ui-widget-header left_panel">{$user_profile_form_text}</div>
...
function remove_item(id)
{
	$("#fields_"+id).remove();
		...
		<div>
			...
			<form name="user_profile_form" id="user_profile_form">
				<div id="fields"
...
function save_user_profile()
{
			...
			$.ajax({
				type : "POST",
				url : "index_admin.php?route=forms&action=save_user_profile",
