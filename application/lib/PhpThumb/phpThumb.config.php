...
//$PHPTHUMB_CONFIG['cache_directory'] = '../../data/cache/uploaded_images/';                            // set the cache directory relative to the phpThumb() installation
$PHPTHUMB_CONFIG['cache_directory'] = ROOT_DIR.'data/cache/uploaded_images/'; // set the cache directory to an absolute directory for all source images
...
$PHPTHUMB_CONFIG['cache_source_directory'] = ROOT_DIR . 'data/cache/uploaded_images/source/';  // set the cache directory for unprocessed source images
