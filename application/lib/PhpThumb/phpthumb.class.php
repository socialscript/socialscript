...
//print $filename . '<br />';
	//	print $GLOBALS['root_dir'] . 'data' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . $filename;
		//exit();
		//return;`
		//print ROOT_DIR . 'data' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . $filename;
		//exit();
return ROOT_DIR . 'data' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . $filename;
		...
		print str_replace('lib\PhpThumb\\','lib\PhpThumb\\..\\data/uploads/',$AbsoluteFilename);
		//exit();
		//$AbsoluteFilename = 'C:\Program Files (x86)\Zend\Apache2\htdocs\community\community\data/uploads/70da0e643f339a67ed0216193541538c\photos/2b2718bfe6572488fe1f0665608757c1\dvd-icon.png';
