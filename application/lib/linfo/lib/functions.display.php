...
<head>
	...
	<link href="resources/js/linfo/favicon.ico" type="image/x-icon" rel="shortcut icon" />
	<link href="resources/js/linfo/styles.css" type="text/css" rel="stylesheet" />'.( $show_icons ? '
	<link href="resources/js/linfo/icons.css" type="text/css" rel="stylesheet" />' : ''
	).'
	<script src="resources/js/linfo/scripts.min.js" type="text/javascript"></script>
	<meta name="generator" content="'.AppName.' ('.VERSION.')" />
	<meta name="author" content="Joseph Gillotti &amp; friends" />
	<!--[if lt IE 8]>
	<link href="resources/js/linfo/old_ie.css" type="text/css" rel="stylesheet" />
	<![endif]-->
</head>
<body id="info">
